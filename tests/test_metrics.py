...
def main():
    image_root_path = '/home/lh/weed_photos_resize_v4/'
    output_path = '/home/lh/WeedClassification/outputs/weed-v4-inaturalist-inception/'
    image_list_file = "../data/v4/weed_image_lists_oversample.json"
